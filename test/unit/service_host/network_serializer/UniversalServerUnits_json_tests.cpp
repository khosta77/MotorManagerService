...
BOOST_FUSION_DEFINE_STRUCT((pkg), S1, (int, r0))

BOOST_FUSION_DEFINE_STRUCT((pkg), S2, (float, val))

BOOST_FUSION_DEFINE_STRUCT(
    (pkg),
    S3,
    (int, r1)(double, r2)(std::string, some_str)(std::vector<int>, vals)(pkg::S2, s2_val)(
        std::vector<pkg::S1>,
        s1_vals))

BOOST_FUSION_DEFINE_STRUCT((pkg), S4, (bool, val))
