...
{
    char* argv[] = {(char*)"program_name", (char*)"192.168.1.1", (char*)"8080"};
...
TEST(IpFromMainInputTest, InvalidNumberOfArguments)
{
    ...
    char* argv2[] = {(char*)"program_name", (char*)"192.168.1.1"};
    int argc2 = sizeof(argv2) / sizeof(argv2[0]);
    EXPECT_THROW(IpFromMainInput ip(argc2, argv2), std::invalid_argument);

    char* argv3[] = {(char*)"program_name", (char*)"192.168.1.1", (char*)"8080", (char*)"extra_arg"};
...
{
    char* argv[] = {(char*)"program_name", (char*)"192.168.1.1", (char*)"not_a_number"};
    int argc = sizeof(argv) / sizeof(argv[0]);
...
{
    char* argv[] = {(char*)"program_name", (char*)"192.168.1.1", (char*)"-1"};
    int argc = sizeof(argv) / sizeof(argv[0]);
...
TEST(IpFromMainInputTest, InvalidIpFormat)
{
    ...
    {
        char* argv[] = {(char*)"program_name", const_cast<char*>(ip.c_str()), (char*)"8080"};
        int argc = sizeof(argv) / sizeof(argv[0]);
...
{
    char* argv1[] = {(char*)"program_name", (char*)"192.168.1.1", (char*)"0"};
    int argc1 = sizeof(argv1) / sizeof(argv1[0]);
